...
public class StringUtil {
    ...
    public static int saveConvert(String theString, byte[] dst, int offset, boolean escapeSpace, boolean lengthFlag, boolean getLengthFlag) {
        if (false == getLengthFlag && (null == dst || dst.length < (offset + (lengthFlag ? 1 : 0)) || dst.length < 1 || offset < 0))
            return -1;
        if (null == theString)
            theString = "";
     ...
     * Method trim space
     *
     * @param oldString string to be format.
     *
     */
     ...
     *
     * @param buffer string to be format.
     *
     */
     ...
     * }
     *
     * @param bufferString string to be format.
     *
     */
     ...
     * Method fill string
     *
     * @param formatString string to be format.
     *
     */
     ...
     *
     * @param abyte0 string to be format.
     *
     */
     ...
     * Method Check String
     *
     * @param hexString string to be format.
     *
    ...
    public static boolean isalphaNumeric(String s) {
        ...
        while (i < len && (Character.isLowerCase(s.charAt(i)) || Character.isUpperCase(s.charAt(i)) || Character.isDigit(s.charAt(i)))) {
            i++;
        }
        return (i >= len);
    }

    public static String getDataBetweenTags(String src, String startTag, String endTag) {
        String result = "";
     ...
     * @return Return true if the string is a Double
     */
